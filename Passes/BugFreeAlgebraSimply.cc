...
bool BugFreeAlgebraSimplyPass::runOnFunction(Function &F, FunctionAnalysisManager &FAM) {
...
bool BugFreeAlgebraSimplyPass::checkEqv(ICmpInst *I0, ICmpInst *I1) {
	...
	SMTExprRef Q = bool2bv(Solver, Solver->mkNot(Solver->mkEqual(VG->get(I0), VG->get(I1))));
