...
llvm::SMTExprRef mkBVSAddOverflow(llvm::SMTSolverRef &, const llvm::SMTExprRef &, const llvm::SMTExprRef &);
llvm::SMTExprRef mkBVSAddOverflow(llvm::SMTSolverRef &, const llvm::SMTExprRef &, const llvm::SMTExprRef &);
llvm::SMTExprRef mkBVUAddOverflow(llvm::SMTSolverRef &, const llvm::SMTExprRef &, const llvm::SMTExprRef &);
llvm::SMTExprRef mkBVSSubOverflow(llvm::SMTSolverRef &, const llvm::SMTExprRef &, const llvm::SMTExprRef &);
